...
While Indigenous knowledge of Átl’ka7tsem's plant life traces back to time immemorial, Western scientific documentation of the region's flora dates to 1897, with the early collection efforts of James Anderson and Albert J. Hill. Over the last century and a half, efforts to document the regional flora were most concentrated in the 1920s, and from the 1960s through the 1980s, before expanding significantly in the 21st century with the advent of iNaturalist, with many thousands of observations made by community members through the <a href = "https://www.squamishenvironment.ca/projects/biodiversity-squamish/">Howe Sound Biodiversity project</a>.
...
Through the combined efforts of `r length(unique(plants$recordedBy))` individuals, the Átl’ka7tsem/Howe Sound naturalist community has documented `r nrow(plant.summary)` species, confirming `r round((nrow(confirmed)/(nrow(confirmed)+nrow(reported))*100), digits = 0)` percent of the historically reported vascular plant diversity and adding `r nrow(new)` new species reports to the list. Community members have now documented `r round((nrow(observed)/(nrow(plant.summary))*100), digits = 0)` percent of the regional plant diversity on iNaturalist.
