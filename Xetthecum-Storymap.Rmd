...
ecologicalMap <- mx_ecological_map("Forests")
ecologicalMap
```
...
```{r, echo=FALSE, message=FALSE}
source("scripts/ecological_map_script.R")
ecologicalMap <- mx_ecological_map("Freshwater")
ecologicalMap
```
...
```{r, echo=FALSE, message=FALSE}
source("scripts/ecological_map_script.R")
ecologicalMap <- mx_ecological_map("Marine")
ecologicalMap
```
...
```{r, echo=FALSE, message=FALSE}
source("scripts/ecological_map_script.R")
ecologicalMap <- mx_ecological_map("Woodlands")
ecologicalMap
```
