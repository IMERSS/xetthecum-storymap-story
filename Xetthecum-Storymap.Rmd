...
<p>The name 'Xetthecum' refers specifically to Retreat Cove. Yet in the landscape context, where everything is connected, its boundaries might be expanded to include the greater extent of the Greig Creek Watershed, including the creek which runs from Laughlin Lake to the cove. This watershed spans residential and agricultural lands, protected and covenanted areas, as well as a public shore access and dock. Complex in its ecology, cultural history, and contemporary land-use, this coastal landscape is a vibrant mosaic of many intersecting ways of life, weaving together both human and more-than-human worlds.</p> 

<p>From here, we welcome you to explore Xetthecum's ecological communities, including their biodiversity and cultural values as shared by community members, or continue along the lines of this story map's main narrative by clicking the right arrow.</p>
...
deltaMap <- plot_mapbox_map("Delta_pI", delta_bbox, allSources, classStyling, highlightedLayers)
deltaMap
```
...
highlightedLayers <- c("Delta");
delta_bbox <- mx_read("spatial_data/vectors/Delta") %>% st_bbox();
deltaMap <- plot_mapbox_map("Delta_pII", delta_bbox, allSources, classStyling, highlightedLayers)
deltaMap
```

<img src="img/oyster2.png">
<p>A large bed of Pacific oysters is established at the Greig Creek delta.</p>

<p>The delta at Xetthecum has changed dramatically since the days of stories recounted by Thiyaas. Once rich with a great variety of shellfish, today the area is dominated by the introduced [tl'uxwtl'uxw](#taxon:Magallana gigas) (Pacific oyster), which Thiyaas did not recall observing when she visited this place with her family in the past.</p>
...
eelgrassMap <- plot_mapbox_map("Eelgrass_pI", eelgrass_bbox, allSources, classStyling, highlightedLayers)
eelgrassMap
```
...
highlightedLayers <- c("EelgrassSimplified");
eelgrass_bbox <- mx_read("spatial_data/vectors/EelgrassSimplified") %>% st_bbox();
eelgrassMap <- plot_mapbox_map("Eelgrass_pII", eelgrass_bbox, allSources, classStyling, highlightedLayers)
eelgrassMap
```
...
<p>The Hul'q'umi'num' name for Greig Creek is Hwta’loonèts, as shared by Thiyaas, who recounted her memories of Xetthecum.
...
```{r, echo=FALSE, message=FALSE}
highlightedLayers <- c()
futureVisionMap <- plot_mapbox_map("Future Vision", project_bbox, allSources, communityStyling, highlightedLayers)
futureVisionMap
```
...
<p>Surrounded by water, Galiano Islanders see the ocean as intrinsic to living and loving life on this island. Sightings of [q'ul-lhanamutsum](#taxon:Orcinus orca) (orcas) and other marine mammals are treasured hallmarks of island life. However, for many community members, the ocean is first and foremost a source of food and livelihood. Both Indigenous and non-Indigenous people on Galiano enjoy fish such as [thuqi'](#taxon:Oncorhynchus nerka) (sockeye salmon), [haan](#taxon:Oncorhynchus gorbuscha) (pink salmon), [tuqwtuqw](#taxon:Sebastes ruberrimus) (red snapper) and other [t’q’as](#taxon:Sebastes) (rockfish). Also prized are [s-axwa'](#taxon:Saxidomus gigantea) (butter clam), kwuneem'mun' (scallops), [ey'x](#taxon:Metacarcinus magister) (dungeness crab), [thikwt](#taxon:Apostichopus californicus) (sea cucumber) and seaweeds such as [lhuq'us](#taxon:Pyropia) (red laver). Thiyaas (Florence James) shared that ['e s-hw](#taxon:Phoca vitulina richardii) (harbour seal) is also prized as a dark meat.</p> 
...
<p>Puneluxutth’ elder Thiyaas (Florence James) calls this type of ecosystem shthuliim: “a beautiful meadow with cushions for your feet made of moss, tender growth, grass…” She shared that p'hwulhp (Garry Oak) was made crooked by the creator so that its branches are useless to people and it will be left alone. In many parts of the Salish Sea, these communities have historically been maintained by controlled burning practices. Hence, Thiyaas regards the presence of p'hwulhp as evidence that the land is being taken care of. Thiyaas told us that pheasant, quail, and [miit'](#taxon:Dendragapus fuliginosus) (grouse) were once a lot more abundant in these woodland environments, and were once a regular part of Indigenous people’s diets in this area. Thiyaas used to collect [fawn lilies](#taxon:Erythronium oreganum) and [ti'tuqw-el'tun'](#taxon:Calypso bulbosa var. occidentalis) (lady slippers) for her mother. “That was just our joy”... but there is not enough to collect anymore.”</p> 
