...
<div class="tab-content" id="myTabContent">
  ...
  Select the ecological community regions on the map or from the tabs here to learn more about thecultural values and species that live here.
  </div>
  <div class="tab-pane fade show active" id="forests" role="tabpanel" aria-labelledby="home-tab">
    <strong>Thuthiqut – Forest</strong>
    <p>Including Mature, Young, and Pole Sapling</p>
    <img src="img/Mature_Conifer_Forest.jpg">
    <p>
  ...
  <div class="tab-pane fade" id="freshwater" role="tabpanel" aria-labelledby="profile-tab">
    <strong>Tl'elhumqa' – Freshwater</strong>
  ...
  <strong>Shthuliim – Woodlands</strong>
