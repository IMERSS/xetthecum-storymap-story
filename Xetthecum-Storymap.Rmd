...
<p>Littleneck clams ([skw'lhey](#taxon:Leukoma staminea)) were harvested from the delta during the spring and summer night tides. Other essential marine life, such as butter clams ([s-axwa'](#taxon:Saxidomus gigantea)), basket cockles ([stl'ula'um](#taxon:Clinocardium nuttallii)), and fish like dog (coho) salmon ([the'wun](#taxon:Oncorhynchus kisutch)), were gathered at Retreat Cove and Greig Creek.
...
<p>Thiyaas and her family would sometimes travel to Retreat Cove in the racing canoe. They would pull in near Retreat Island and Thiyaas’ grandfather would walk to Laughlin Lake for medicine.
...
<p>Thiyaas mentions gathering licorice fern ([tlu'siip](#taxon:Polypodium glycyrrhiza)) root from maple trees (bigleaf maple, [q'um'-unulhp](#taxon:Acer macrophyllum)) near Retreat Cove. 
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="introduction-tab" data-bs-toggle="tab"    data-bs-target="#introduction" type="button" role="tab" aria-controls="introduction"    aria-selected="true">Introduction</button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="forests-tab" data-bs-toggle="tab" data-bs-target="#forests" type="button" role="tab" aria-controls="forests" aria-selected="true">Thuthiqut Forests</button>
  </li>
  <li class="nav-item" role="presentation">
...
<div class="tab-content" id="myTabContent">
  ...
  Select the ecological community regions on the map or from the tabs here to learn more about the cultural values and species that live here.
  </div>
...
<b>Ecological Community: Freshwater</b>
#### Species commonly found at Laughlin Lake
...
<b>Ecological Community: Freshwater</b>
#### Species commonly found at Greig Creek
<div class="species-card">
...
<b>Ecological Community: Marine - Shoreline</b>
#### Species commonly found at the Delta
<div class="species-card">
<img src="img/tluxwtluxw.png">
<p>tl'uxwtl'uxw</p>
<p>pacific oyster</p>
