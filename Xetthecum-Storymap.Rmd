...
<blockquote>Elder Thiyuas (Florence James) expressed her hope that the caves at Xetthecum might be protected.</blockquote>  
...
highlightedLayers <- c()
context_bbox <- mx_read("spatial_data/vectors/Context") %>% st_bbox();
acknowledgmentMap <- plot_mapbox_map("Acknowledgment", context_bbox, allSources, communityStyling, highlightedLayers)
acknowledgmentMap
```
...
<p>Puneluxutth’ elder Thiyuas (Florence James) and her family once gathered a rich array of resources at Xetthecum, traveling from Retreat Cove to Laughlin Lake and back, collecting berries, fruit, shellfish, and medicinal resources along the way. This story map begins with the rich abundance of marine life found at the cove, before following in the footsteps of Thiyuas (Florence James) and her family up Greig Creek to Laughlin Lake.</p> 
...
<p>Important cultural activities that took place at Xetthecum included:
<img src="img/icon_shellfish.png"><b>Fishing, Hunting and Shellfish Harvesting</b>
<img src="img/icon_berry.png"><b>Gathering Berries and Plant Materials</b>
...
CoveMap <- plot_mapbox_map("Cove", cove_bbox, allSources, communityStyling, highlightedLayers)
CoveMap
```

<p>For those who arrived at Xetthecum by canoe, the cove was of foremost importance as a place of refuge, where one could find calmer waters to rest or to retreat during a storm. Puneluxutth’ elder Augie Sylvester recalled canoeing from the North End reserve down to Retreat Cove, around Retreat Island, and sometimes all the way back up to the reserve. Canoe pullers trained hard to be able to race! The cove and surrounding offshore waters also provide habitat for a great diversity of fishes such as [the'wun](#taxon:Oncorhynchus kisutch) (coho), which made it an important fishing site. Today, however, Retreat Cove lies within a marine protected area, to protect endangered [t'q'as](#taxon:Sebastes) (rockfish) from over-fishing.</p> 

<p>Beyond a place of refuge and fish, Retreat Cove opens up on an important source of freshwater, as well as opportunities for hunting and travel. Lying at the narrowest point on the island, a shore-to-shore footpath connected Retreat Cove with Cable Bay, allowing over-land travel across the island. Augie recalled landing at Xetthecum and walking across the island to Pebble Beach, to hunt for [ha’put](#taxon:Odocoileus hemionus columbianus) (deer). Like other Indigenous community members, Augie also recalled harvesting shellfish at Xetthecum. After hunting or harvesting, they would sometimes row across to Fernwood to trade meat, fish, or shellfish for vegetables with the Sampson family.

<div class="data-pane">
<p>Those with a deep connection to Xetthecum all shared a common experience in relation to the rich marine biodiversity of this place:</p>
