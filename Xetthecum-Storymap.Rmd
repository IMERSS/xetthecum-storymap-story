...
Littleneck clams ([skw'lhey](#taxon:Protothaca staminea)) were harvested during the spring and summer night tides. Other essential marine life, such as butter clams ([s-axwa'](#taxon:Saxidomus gigantea)), basket cockles ([stl'ula'um](#taxon:Clinocardium nuttallii)), and fish like dog (coho) salmon ([the'wun](#taxon:Oncorhynchus kisutch)), were gathered at Retreat Cove and Greig Creek. 

The shellfish were laid overtop of kelp (bull kelp, [q'am'](#taxon:Nereocystis)) and then stepped on to get the water out; ironwood (oceanspray, [qethulhp](#taxon:Holodiscus discolor)) was singed in the fire, used to poke the clams and then stuck in the mud by the fire to cook them. Cedar bark ([xpey'](#taxon:Thuja plicata)) was made into string/rope which was used to string up clams by the fire. After they were cooked they would smoke the shellfish. 
...
Laughlin Lake is part of a complex wetland ecosystem supporting a diversity of plant life, including culturally significant species like cattail ([stth’e’qun](#taxon:Typha latifolia)) and fireweed ([xáts’et](#taxon:Chamaenerion angustifolium)). The riparian areas surrounding the lake are crucial for wildlife, offering habitat for species like black-tailed deer ([ha’put](#taxon:Odocoileus hemionus columbianus)) and great blue heron ([smuqw’a’](#taxon:Ardea herodias)).
...
```{r, echo=FALSE, message=FALSE}
source("scripts/biodiversity_map_script.R")
biodiversityMap <- mx_biodiversity_map()
biodiversityMap
```
